...
function Navbar() {
  ...
  return (
    <main className='border-b-2 bg-neutral-110'>
      <div className='w-full flex items-center justify-center bg-white h-[80px]'>
        {/* all content */}
        <div className='sm:w-full md:w-[90%]  flex items-center justify-between h-[50px]'>

          <div>
            {/* logo */}
            <h2 className="title-font font-bold text-blue-940 tracking-widest text-xl mb-3">
        Hekto
        </h2>
          </div>
          ...
          >
            <ul className='flex flex-col md:flex-row md:gap-x-2 lg:gap-x-5 xl:gap-x-5 2xl:gap-x-10 sm:text-md md:text-sm lg:text-md xl:text-md text-white md:text-black '>
              <li className='p-4 hover:underline hover:text-pink-650 underline-offset-2'>
                <Link href="/">Home</Link>
              </li>
